...
const FetchData = ({ cat }) => {
  ...
  const apiUrl = cat
    ? `https://gnews.io/api/v4/top-headlines?country=in&topic=${cat}&lang=en&token=801c8fb1f96ff7ec5ed280dcc750b990`
    : `https://gnews.io/api/v4/top-headlines?country=in&lang=en&token=801c8fb1f96ff7ec5ed280dcc750b990`;
